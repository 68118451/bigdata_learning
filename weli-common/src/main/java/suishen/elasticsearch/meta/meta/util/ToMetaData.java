package suishen.elasticsearch.meta.meta.util;

import suishen.elasticsearch.meta.annotations.aggs.bucket.DateHistogramAgg;
import suishen.elasticsearch.meta.annotations.aggs.bucket.TermsAgg;
import suishen.elasticsearch.meta.annotations.nested.Nested;
import suishen.elasticsearch.meta.annotations.nested.NestedDynamicPath;
import suishen.elasticsearch.meta.annotations.termLevelQuery.DateRangeQuery;
import suishen.elasticsearch.meta.annotations.termLevelQuery.NumRangeQuery;
import suishen.elasticsearch.meta.annotations.termLevelQuery.TermOrTermsQuery;
import suishen.elasticsearch.meta.annotations.textQuery.MatchQuery;
import suishen.elasticsearch.meta.exception.DataTypeNotSupportException;
import suishen.elasticsearch.meta.meta.query.MetaDataCombination;
import suishen.elasticsearch.meta.meta.query.MetricType;
import suishen.elasticsearch.meta.meta.query.NumType;
import suishen.elasticsearch.meta.meta.req.BoolType;
import suishen.elasticsearch.meta.meta.req.ReqListMeta;
import suishen.elasticsearch.meta.meta.req.ReqObjectMeta;
